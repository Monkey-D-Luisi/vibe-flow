    ...
    properties: {
      ...
      policy: {
        ...
        properties: {
          ...
          accessibilityMaxViolations: { type: 'number' },
          auditMaxCritical: { type: 'number' },
          auditMaxHigh: { type: 'number' },
        },
      ...
      metrics: {
        ...
        properties: {
          ...
          accessibilityViolations: { type: 'number' },
          auditCritical: { type: 'number' },
          auditHigh: { type: 'number' },
        },
        additionalProperties: false,
      },
      history: {
