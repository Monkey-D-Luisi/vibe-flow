...
import { assertOptionalStringArray, assertOptionalString, assertOptionalNumber, } from '@openclaw/quality-contracts/validate/tools';
 ...
 */
function countCyclomaticSimple(source) {
    let complexity = 1;
    const patterns = [
        /\bif\s*\(/g,
        /\belse\s+if\s*\(/g,
 ...
 */
export async function complexityTool(input) {
    ...
    const averageCyclomatic = totalFunctions > 0
