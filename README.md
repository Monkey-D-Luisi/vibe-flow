...
- `design-ready-lint` (from `.github/workflows/design-ready-lint.yml`)
...
- Author the typed spec in `docs/epics/EP04-architecture-and-adrs/T03-typed-design-ready/10-spec.md`.
- Generate the machine-checked artifact with `pnpm design:gen` (writes `20-design_ready.json` next to the spec).
