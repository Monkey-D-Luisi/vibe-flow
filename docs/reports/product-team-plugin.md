...
The record below is queried directly from the live Docker container's SQLite database. It shows the full 10-stage pipeline running end-to-end — the most complete demonstration of all system capabilities working together.

### Case study — Full pipeline: 8 agents build a landing page in 4 minutes
