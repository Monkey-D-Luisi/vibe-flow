...
| #155 | Threshold alerts: notify on coverage drops or complexity rises | EP05 follow-up (quality alerting) | Task `0021` PENDING (`docs/tasks/0021-threshold-alerts-notify-on-coverage-drops-or-complexity-rises.md`) | Execute task `0021` from the active queue and finalize transport/channel + alert policy implementation. |
