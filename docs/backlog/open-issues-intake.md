...
|-------|-------|----------------|-----------------|-----------------------|
| #154 | Gate auto-tuning: adjust thresholds based on historical metrics | EP05 follow-up (quality optimization) | Not in task specs | Create dedicated task spec with policy inputs, safeguards, and tuning evidence requirements. |
